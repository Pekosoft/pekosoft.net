...
<div class="feature-row module">
  ...
  <div class="justify">
    ...
    Shows the current playback timer.
  </div>
</div>
...
<div class="feature-row module">
  ...
  <div class="justify">
    ...
    Buttons, fields, menus, knobs and sliders are collected in the Controls module. Status bar explains hovered controls and provides feedback.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Input <span class="object">menu</span></h1>
    Selects active audio input device.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Response <span class="object">menu</span></h1>
    Selects instant or fade response for play and stop.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Rewind <span class="object">button</span></h1>
    Moves playback position backward by 0.5 seconds. Supports hold.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Fast-forward <span class="object">button</span></h1>
    Moves playback position forward by 0.5 seconds. Supports hold.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Progress <span class="object">slider</span></h1>
    Sets and shows playhead position.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Sets and shows volume. Range: 0 to 100. <span class="default">Default: 100.</span>
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Position / Duration / Selection / Remain <span class="object">fields</span></h1>
    Show current time, total duration, selected duration and remaining time.
  </div>
</div>
...
<div class="feature-row module">
  ...
  <div class="justify">
    ...
    Shows waveform, selection and playhead. Includes destructive waveform edit tools.
  </div>
</div>
