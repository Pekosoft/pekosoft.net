...
<div class="feature-row module">
  ...
  <div class="justify">
    ...
    Buttons, fields, menus and toggles are collected in the Controls module. Status bar explains the interface and provides feedback.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Shows the BPM at the current playhead position. Dragging points changes this value live.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Beats <span class="object">field</span></h1>
    Shows the total beats under the full curve.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Points <span class="object">field</span></h1>
    Shows how many curve points are currently on the graph.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Sets the playhead position through the curve and updates the live readout.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Sets the preview tone frequency used during playback.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Chooses interpolation family: Linear, Exponential, Logarithmic or Sinusoid. <span class="default">Default: Sinusoid.</span>
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Point handles <span class="object">interaction</span></h1>
    Drag point handles directly on the graph to reshape the curve.
  </div>
</div>
