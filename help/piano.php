<div class="feature-row border">
  ...
  <div class="justify">
    <h1>General</h1>
    Pekosoft Piano is a playable keyboard with octave navigation, tone, piano roll, recording and playback tools.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Chooses the waveform used for played notes: Sine, Square, Sawtooth, Triangle or Piano. <span class="default">Default: Sine.</span>
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Shows the frequency in hertz for the last played note.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Note <span class="object">field</span></h1>
    Shows the note name for the last played note.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Adjusts master output volume from 0 to 100%. Minus and plus buttons step the value down or up. <span class="default">Default: 100.</span>
  </div>
</div>
...
<div class="feature-row module">
  ...
  <div class="justify">
    ...
    The Timeline module shows the piano roll view of played and recorded notes.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>GUIDES <span class="object">button</span></h1>
    Toggles guides in Timeline. Horizontal piano roll grid lines show key rows. <span class="default">Default: on.</span>
  </div>
</div>
