...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Icons <span class="object">field</span></h1>
    Displays the total number of icons.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Grid <span class="object">field</span></h1>
    Sets and displays preview grid size. Updates the grid size knob accordingly.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>KB <span class="object">field</span></h1>
    Displays the total file size.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Name <span class="object">field</span></h1>
    Displays the selected icon ID.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    <h1>Search <span class="object">field</span></h1>
    Filters the icon grid by icon ID.
  </div>
</div>
...
<div class="feature-row border">
  ...
  <div class="justify">
    ...
    Sets and displays autoplay speed as a percentage. Range: 25 to 200. Step: 1. Updates the speed knob accordingly. <span class="default">Default: 100.</span>
  </div>
</div>
...
<div class="feature-row module">
  ...
  <div class="justify">
    ...
    This is an alphabetical grid view of the icons. Hover to see name. Click to display.
  </div>
</div>
